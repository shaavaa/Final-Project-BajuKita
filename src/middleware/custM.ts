...
export const verifyAddCust = (request: Request, response: Response, next: NextFunction) =>{
...
export const verifyUpdateCust = (request: Request, response: Response, next: NextFunction) =>{
